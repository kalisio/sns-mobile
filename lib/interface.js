...
Interface.prototype.subscribe = function (endpointArn, topicArn, callback) {
  var self = this
  self.subscribeWithProtocol(endpointArn, topicArn, 'application', callback)
}
...
Interface.prototype.sendMessage = function (endpointArn, msg, callback) {
  ...
  convertFn.call(this, msg, function (err, message) {
    ...
    if (message.sms) params.PhoneNumber = endpointArn
...
Interface.prototype.convertToGcmFormat = function (message, callback) {
  ...
  var container = {}
  var key = (this.platform === SUPPORTED_PLATFORMS.ANDROID) ? 'GCM' : 'ADM'
  ...
  if (typeof message === 'string') {
    ...
    if (message.GCM || message.ADM || message.default || message.sms) {
